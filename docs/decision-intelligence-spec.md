...
**Opportunity scoring**
- Score clusters on brand coverage, document breadth, recency, type diversity, signal strength, and severity.
...
- `flag_portfolio_risk` when concentration risk or weather/region risk threatens multiple brands.
